  ...
  <div class="in-frame">
      ...
      <div class="sidebar-widget-planos plano-sidebar">
        ...
        <div class="acc-content">
          <ul>
            ...
            <li class=""><a href="planos-piso-2.php">PISO 2</a></li>
            <li class=""><a href="planos-piso-3.php">PISO 3</a></li>
            <li class="active"><a href="planos-piso-4.php">PISO 4</a></li>
    ...
    <div class="inner-content template-sidebar-right section-planos">
      <article>
        <header>
          <h1>4</h1>
          <h2>ACCESO A TERRAZA DE LA BALLENA AZUL</h2>
          <h2>SALA EVA PERÓN</h2>
          <h2>AUDITORIOS</h2>
          <h2>SALAS</h2>
          <h2>EP4 Ascensor accesible a Terraza de La Ballena</h2>
        </header>
        <div class="plano">
          <span class="zoom-panel">
            <i class="fa fa-search-plus"></i>
          </span>
          <img src="assets/img/planos/4.jpg" />
        </div>
        <div class="plano-info">
          ...
          <ul>
            <li>
              <h3 class="expo-title color-muestraspermanentes">Sala Eva Perón</h3>
              <span class="expo-description"></span>
            </li>
          </ul>
        </div>
      </article>
