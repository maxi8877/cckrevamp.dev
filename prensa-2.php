      ...
      <section class="article-prensa-2-static">
        <ul>
          ...
          <li>
            ...
            <!-- Comienzo loop de Noticias -->

            <article class="item">
              <header>
                <h4>
                  <strong>NOTICIA</strong> 1 de Julio</h4>
                <h1>
                  De Vido y Recalde recorrieron el Centro Cultural Kirchner y firmaron convenios
                </h1>
              </header>
              <figure>
                <img src="http://imagenes.minplan.gob.ar/servicios/octopus/imgmagic.php?y=687&imagen_id=25366" />
                <figcaption>
              ...
              <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque
                eu, pretium quis ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor.</p>
              <footer>
                <a class="button" href="prensa-in.php">Seguir Leyendo</a>
              </footer>
            </article>
