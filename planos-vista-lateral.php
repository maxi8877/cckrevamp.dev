...
<section id="content-inside">
  <div class="in-frame">
        ...
        <li>
          <div class="header-title-container">
            <h1>
              ...
              <a href="#">Visitar / </a>
              <span class="light"><a href="planos-piso-0.php">Plano</a> / Vista Lateral</span>
      ...
      <div class="sidebar-widget-planos plano-sidebar">
        ...
        <div class="acc-content">
          <ul>
              ...
              <li class="active"><a href="planos-vista-lateral.php">Corte longitudinal del CCK</a></li>
            </ul>
        </div>
      </div>
    ...
    <div class="inner-content template-sidebar-right section-planos">
      <article>
        <header>
          <h1 class="lateral">Vista Lateral</h1>
        ...
        <div class="plano">
          ...
          <img src="assets/img/planos/lateral.jpg" />
        </div>
