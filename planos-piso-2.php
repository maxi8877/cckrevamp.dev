  ...
  <div class="in-frame">
        ...
        <li>
          <div class="header-title-container">
            <h1>
              ...
              <a href="#">Visitar / </a>
              <span class="light"><a href="planos-piso-0.php">Plano</a> / Piso 2</span>
    ...
    <div class="inner-content template-sidebar-right section-planos">
      <article>
        <header>
          <h1>2</h1>
          <h2 class="cyan">LA BALLENA AZUL</h2>
          <h2>SALÓN DE LOS ESCUDOS</h2>
          <h2>SALÓN DE HONOR</h2>
        </header>
        <div class="plano">
          <span class="zoom-panel">
            <i class="fa fa-search-plus"></i>
          </span>
          <img src="assets/img/planos/2.jpg" />
        </div>
        <div class="plano-info">
          ...
          <ul>
            <li>
              <h3 class="expo-title color-artesvisuales">Sophie Calle</h3>
              <span class="expo-description">Salón De Honor, Salón De Los Escudos, Salas 209, 210, 211, 212 213 Y 214</span>
            </li>
            <li>
              <h3 class="expo-title color-artesvisuales">Arte y correo</h3>
              <span class="expo-description">Salas 203, 204, 205 Y 206</span>
            </li>
            <li>
              <h3 class="expo-title color-muestraspermanentes">Experiencia NK</h3>
              <span class="expo-description">Sala Néstor Kirchner</span>
            </li>
          </ul>
        </div>
      </article>
