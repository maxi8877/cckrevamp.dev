<?php include( 'header.php'); ?>
  ...
  <section id="content-inside" class="online">
    <div class="in-frame">
        ...
        <ul>
          <li>
            <div class="header-title-container">
              <h1>
                <a href=verescuchar.php">Ver / Escuchar</a> / <a class="br-subsection" href="#">Video</a> / <a class="br-category br-tuvoz" href="#">Tu Voz</a>
              </h1>
            </div>
          </li>
      ...
      .inner-content .tuvoz
      -->
      <div class="inner-content section-ver-escuchar tuvoz">
                  ...
                  <div class="overlay">
                    <div class="bigfat">
                      <h1>Sophie Calle<br>
                        ...
                        <h1>
                          <span class="tag1 tag-tuvoz">artes visuales</span><span class="tag2">internacional</span>
                    </div>
                  </div>
