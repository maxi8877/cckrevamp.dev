  ...
  <div class="in-frame">
    ...
    <div id="secondary" class="right">
      <div class="sidebar-widget-planos plano-sidebar">
        ...
        <div class="acc-content">
          <ul>
            <li class="active"><a href="planos-piso-sub.php">SUBSUELO</a></li>
    ...
    <div class="inner-content template-sidebar-right section-planos">
      <article>
        <header>
          <h1>-1</h1>
          <h2>SALA ARGENTINA</h2>
          <h2>SUCURSAL DE CORREO</h2>
          <h2>MUSEO DEL CORREO</h2>
        ...
        <div class="plano">
          ...
          <img src="assets/img/planos/sub.jpg" />
        </div>
