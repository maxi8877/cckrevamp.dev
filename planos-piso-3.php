  ...
  <div class="in-frame">
      ...
      <div class="sidebar-widget-planos plano-sidebar">
        ...
        <div class="acc-content">
          <ul>
            ...
            <li class="active"><a href="planos-piso-3.php">PISO 3</a></li>
    ...
    <div class="inner-content template-sidebar-right section-planos">
      <article>
        <header>
          <h1>3</h1>
          <h2 class="">LA BALLENA AZUL</h2>
          <h2>SALAS</h2>
          <h2>EP3 La Ballena Azul / Acceso a Bandeja 2</h2>
        </header>
        <div class="plano">
          <span class="zoom-panel">
            <i class="fa fa-search-plus"></i>
          </span>
          <img src="assets/img/planos/3.jpg" />
        </div>
