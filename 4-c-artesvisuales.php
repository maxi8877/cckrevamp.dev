      ...
      <ul>
        <li>
          <div class="header-title-container">
            <h1>
              <a href=verescuchar.php">Ver / Escuchar</a> / <a class="br-subsection" href="#">Video</a> / <a class="br-category br-artesvisuales" href="#">Artes Visuales</a>
            </h1>
          </div>
        </li>
                ...
                <div class="overlay">
                  <div class="bigfat">
                    <h1>Sophie Calle<br><span class="bajada">Sueña que duerme en el fondo del mar</span>
                      <h1>
                        <span class="tag1 tag-artesvisuales">artes visuales</span><span class="tag2">internacional</span>
                  </div>
                </div>
